...
# Configure
ENV["BENCHMARK"] = "nmf:dagger"
ENV["BENCHMARK_RENDER"] = "webdash"
ENV["BENCHMARK_PROCS"] = "2:2"
# ENV["BENCHMARK_RENDER"] = "custom1"
# ENV["BENCHMARK_RENDER"] = "custom2"
# ENV["BENCHMARK_SCALE"] = "16:5:17"
# ENV["BENCHMARK_PROFILE"] = "1"
...
function main()
    ...
    if render == "live"
        opts = merge(opts, (;log_sink=Dagger.TimespanLogging.LocalEventLog()))
        if graph
    ...
    elseif render == "custom1"
        configure_LocalEventLog()
    elseif render == "custom2"
        set_log_file("Custom2.log")
    end
